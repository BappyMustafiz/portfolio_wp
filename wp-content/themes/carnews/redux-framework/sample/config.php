<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Redux Theme Options', 'redux-framework-demo' ),
        ...
        'menu_icon'            => get_template_directory_uri().'/images/re-admin.png',
    ...
    Redux::setSection($opt_name, array(
        ...
        'id' =>'logo-gallery',
        'subsection' =>true,
        'desc' =>__('This is logo area', 'redux_carnews'),
        'icon' =>__('el el-file', 'redux_carnews'),
        'fields' => array(
            array(
                'id' => 'opt-logo',
                'type' => 'media',
                'title' => __('Set site logo','redux_carnews'),
                'subtitle' => __('You can upload any logo','redux_carnews'),
                'desc' => __('This is logo description area','redux_carnews'),
                'compiler' => true,
                'default' => array(
    ...
    Redux::setSection($opt_name, array(
        'title' =>__('Favicon', 'redux_carnews'),
        'id' =>'favicon-gallery',
        'subsection' =>true,
        'desc' =>__('This is favicon area', 'redux_carnews'),
        'icon' =>__('el el-file', 'redux_carnews'),
        'fields' => array(
            array(
                'id' => 'opt-favicon',
                'type' => 'media',
                'title' => __('Set site favicon','redux_carnews'),
                'subtitle' => __('You can upload any favicon','redux_carnews'),
                'desc' => __('This is favicon description area','redux_carnews'),
                'compiler' => true,
                'default' => array(
    ...
    Redux::setSection($opt_name, array(
        'title' =>__('Topbar address', 'redux_carnews'),
        'id' =>'topbar-address',
        'subsection' =>true,
        'desc' =>__('This is topbar address area', 'redux_carnews'),
        'icon' =>__('el el-map-marker-alt', 'redux_carnews'),
        'fields' => array(
            array(
                'id' => 'opt-topbar-address',
                'type' => 'text',
                'title' => __('Set topbar address','redux_carnews'),
                'subtitle' => __('You can set topbar address from here','redux_carnews'),
                'desc' => __('This is topbar address area','redux_carnews'),
                'default' => 'Set topbar address'
            ),
        )
    ));
    Redux::setSection($opt_name, array(
        'title' =>__('Topbar social', 'redux_carnews'),
        'id' =>'topbar-social',
        'subsection' =>true,
        'desc' =>__('This is topbar social area', 'redux_carnews'),
        'icon' =>__('el el-facebook', 'redux_carnews'),
        'fields' => array(
            array(
                'id' => 'opt-topbar-facebook',
                'type' => 'text',
                'placeholder' => 'http://www.facebook.com/versatile',
                'title' => __('Set facebook link','redux_carnews'),
                'subtitle' => __('You can set topbar facebook link','redux_carnews'),
                'desc' => __('This is topbar facebook link','redux_carnews')
            ),
            array(
                'id' => 'opt-topbar-twitter',
                'type' => 'text',
                'placeholder' => 'http://www.twitter.com/versatile',
                'title' => __('Set twitter link','redux_carnews'),
                'subtitle' => __('You can set topbar twitter link','redux_carnews'),
                'desc' => __('This is topbar twitter link','redux_carnews')
            ),
            array(
                'id' => 'opt-topbar-google',
                'type' => 'text',
                'placeholder' => 'http://www.google.com/versatile',
                'title' => __('Set google link','redux_carnews'),
                'subtitle' => __('You can set topbar google link','redux_carnews'),
                'desc' => __('This is topbar google link','redux_carnews')
            ),
            array(
                'id' => 'opt-topbar-pintrest',
                'type' => 'text',
                'placeholder' => 'http://www.pintrest.com/versatile',
                'title' => __('Set pintrest link','redux_carnews'),
                'subtitle' => __('You can set topbar pintrest link','redux_carnews'),
                'desc' => __('This is topbar pintrest link','redux_carnews')
            ),
            array(
                'id' => 'opt-topbar-dribble',
                'type' => 'text',
                'placeholder' => 'http://www.dribble.com/versatile',
